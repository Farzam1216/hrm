...
use App\Domain\PayRoll\Actions\DeleteOldPayScheduleDates;

class UpdatePayScheduleDates
{
    /**
    ...
    {
        $deleteOldPayScheduleDates = (new DeleteOldPayScheduleDates())->execute($payScheduleId);
