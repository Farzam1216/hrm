...
class EmployeeTaskCompletedStatus
{
    /**
     * @param $data
    ...
    {
        $employeTask = EmployeeTask::with('task', 'assignedTo', 'assignedFor')->find($data['taskCompletionStatusId']);
        $employeTask->task_completion_status = 1;
        $employeTask->save();
