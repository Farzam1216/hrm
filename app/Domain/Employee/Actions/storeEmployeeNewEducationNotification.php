...
class storeEmployeeNewEducationNotification
{
    public function execute($request,$id)
    {
        ...
        if($previousInfo->id == Auth::user()->id){
            $message =  "$previousInfo->firstname $previousInfo->lastname added  $gender new education.";
        }else{
            $userName = Auth::user()->fullname;
            $message =  "$userName added $previousInfo->fullname new education.";
        }
