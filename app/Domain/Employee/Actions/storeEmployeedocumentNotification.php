...
class storeEmployeedocumentNotification
{
    public function execute($request)
    {
        ...
        if($previousInfo->id == Auth::user()->id){
            $message =  "$previousInfo->firstname $previousInfo->lastname added  $gender new employee document.";
        }else{
            $userName = Auth::user()->fullname;
            $message =  "$userName added $previousInfo->fullname new employee document.";
        }
