...
@section('title','Edit Custom Access Level')
@section('heading')
...
<div class="row">
    <div class="container-fluid">
        <form id="customRole" action="@if(isset($locale)){{url($locale.'/access-level/custom/'.$role->id)}}@else{{url('en/access-level/custom/'.$role->id)}}@endif" method="post" enctype="multipart/form-data">
            @method('PUT')
            {{csrf_field()}}
            <div class="">
                            ...
                            <div class="tab-pane  tab" id="what-sees" role="tabpanel" aria-labelledby="what-sees-tab">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        @foreach ($defaultfullAcessPermissions as $fieldName => $fullPermission)
                                            <div class="col-md-3 col-sm-12">
                                                <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
                                                    <a class="nav-link @if($i == 0) active @endif vert-tabs" id="vert-tabs-{{$fieldName}}-tab" field="{{$fieldName}}" data-toggle="pill" href="#vert-tabs-{{$fieldName}}" role="tab" aria-controls="vert-tabs-{{$fieldName}}" aria-selected="true">
                                        ...
                                        <div class="col-md-12">
                                            <div class="tab-content" id="vert-tabs-tabContent">
                                                @foreach ($defaultfullAcessPermissions as $fieldName => $fullPermission)
                                                <div class="tab-pane text-left fade @if($show) show active @endif" id="vert-tabs-{{$fieldName}}" role="tabpanel" aria-labelledby="vert-tabs-{{$fieldName}}-tab">
                                                    <h4>{{ucwords (str_replace('_', ' ',$fieldName))}}</h4>
                                                    <hr>
                                                    <div class="">
                                                        <!-- checkbox -->
                                                        <div class="form-group mt-2">
                                                            @foreach($fullPermission as $field => $permissions)
                                                            @foreach ($permissions as $key => $permission )
                                                            <div class="custom-control custom-checkbox mt-1 ml-1">
                                                                <input class="custom-control-input" type="checkbox" id="{{$field}}" @if($key==='checked' ) checked @endif value="{{$permission}}" name="fullPermissions[]">
                                                                <label for="{{$field}}" class="custom-control-label">{{ucwords (str_replace('_', ' ',$field))}}</label>
                                                            </div>
                                                            @endforeach
                                                            @endforeach
                                                        </div>
                                                ...
                                                <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                                    <div class="form-group row ">
                                                        <label class=" col-form-label pl-1">
                                                            <i data-feather='lock'></i>&nbsp; <b>This Access Level
                                                                can access the information below for </b>
                                                        </label>
                                                        <div class="pl-1">
                                                            <select class="form-control mr-1" name="access_level" onchange="getEmployees({{$employees}},this.value)">
                                                                <option value="4" @if($accessLevel==4) selected @endif> All Employees </option>
                                                                ...
                                                                <option value="3" @if($accessLevel==3) selected @endif> Only Some Employees.. </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div id="some_employees" style="column-count: 3;">
                                                        @if($accessLevel == 3)
                                                        @foreach ($specificEmployees as $employee)
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" checked id="specific_employees{{$employee->id}}" value="{{$employee->id}}" name="specific_employees[]">
                                                            <label class="custom-control-label" for="specific_employees{{$employee->id}}">{{$employee->firstname}}</label>
                                                        </div>
                                                        @endforeach
                                                        @foreach ($employees->diff($specificEmployees) as $employee)
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="specific_employees{{$employee->id}}" value="{{$employee->id}}" name="specific_employees[]">
                                                            <label class="custom-control-label" for="specific_employees{{$employee->id}}">{{$employee->firstname}}</label>
                                                        </div>
                                                        @endforeach
                                                        @endif
                                                            ...
                                                            <div class="tab-pane fade show @if($count==0) active @endif" id="employee-{{$category}}-info" role="tabpanel" aria-labelledby="employee-{{$category}}-info-tab">
                                                                ...
                                                                @if($group == "checkbox" && $category == "attendance")
                                                                    ...
                                                                    <div class="custom-control custom-control-primary custom-checkbox">
                                                                        <input type="checkbox" name="customPermissions[]" value="view employee_attendance" @if($permissionName == "view employee_attendance" || $permissionName == "edit employee_attendance")) checked @endif class="custom-control-input requestAttendance" id="colorCheck3">
                                                                        <label class=" custom-control-label" for="colorCheck3">
                                                                            Can View Employee Attendance
                                                                        </label>
                                                                    </div>
                                                                    <div class="col-12 attendanceList" @if ($permissionName == "edit employee_attendance" || $permissionName == "view employee_attendance")  style="display:block; width:  auto; border: 1px solid grey; border-radius: 5px; margin-left: 30px; margin-top: 2px; padding: 2px;" @else style="display:none; width:  auto; border: 1px solid grey; border-radius: 5px; margin-left: 30px; margin-top: 2px; padding: 2px; border: 1px solid grey;" @endif>
                                                                        @foreach($permission as $permissionLabel=>$permissionValue)
                                                                        <div class="custom-control custom-checkbox">
                                                                            <input class="custom-control-input myCheckbox" type="checkbox" id="{{$permissionLabel}}" @if($permissionName == "edit employee_attendance")) checked @endif value="edit employee_attendance" name="customPermissions[]">
                                                                ...
                                                                <div class="row col-md-12 pl-2">
                                                                    ...
                                                                    <div class="row col-lg-9 col-md-12 col-sm-12">
                                                                        <div class="mt-2 flex-fill col-md-7 col-sm-4">
                                                                            ...
                                                                            <input type="hidden" id="{{$group}}{{$fieldName}}SelectedValue" style="display: none" @if($key==='checked' ) value="{{$action}}" @endif name="customPermissions[]">
                                                                        ...
                                                                        <div class="mt-1 flex-fill col-md-5 col-sm-6">
                                                                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                                                ...
                                                                                <label class="btn btn-primary p-1 {{$category}}_edit_button @if($key === 'checked') active @endif">
                                                                        ...
                                                                        <div class="row col-lg-9 col-md-12 col-sm-12">
                                                                            ...
                                                                            <div class="mt-1 flex-fill col-md-5 col-sm-6">
                                                                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                                                    ...
                                                                                    @foreach($permissionActions as $key => $action)
                                                                                    @if($flag )
                                                                                    <label class="btn btn-primary p-1 {{$category}}_no_access_button @if($key !== 'checked') active @endif">
                                                                                    ...
                                                                                    @endif
                                                                                    @if(strpos($action, 'view') !== false)
                                                                                    <label class="btn btn-primary p-1  {{$category}}_view_button @if($key === 'checked') active @endif ">
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
                                                    ...
                                                    <div id="toggleAccessWithRadioBtn" class="mt-1 ml-1">
                                                        ...
                                                        <select class="form-control col-md-3 pr-2" id="selectLevel" name="employeeRole">
                                                            ...
                                                            @endforeach
                                                            <option value="full" @if($subRoleAccessLevel !=false) selected @endif>Full
                                                                Full Access
                                                    ...
                                                    <div class="row ml-1" id="mtDiv">
                                                        <div class="custom-control custom-checkbox" id="toggleWithFullAccessOption">
                                                            ...
                                                            <label for="canRequestCb" id="canRequestLabel" class="custom-control-label">Can Request
                                                                Time Off
...
<script>
    ...
    //         $('#selectLevel').append(
    //             '        <option value="fullAccessOption" >Full Access\n' +
    //             '            <small>Allows them to see the\n' +
    //             '                same info about themselves\n' +
    //             '                as they can see about\n' +
    //             '                others.</small>\n' +
    ...
    //hide dropdown if no is checked
