...
@section('title','New Manager Access Level')
@section('heading')
...
<div class="row">
    <div class="container-fluid">
        <form id="managerRole" action="@if(isset($locale)){{url($locale.'/access-level/manager')}}@else{{url('en/access-level/manager')}}@endif" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
                                    ...
                                    <div class="">
                                        <div class="tab-content" id="custom-tabs-one-tabContent">
                                            <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                                <div class="form-group row"><label class="col-form-label pl-1">
                                                    ...
                                                    <div class="pl-1">
                                                        <select class="form-control mr-1" name="managerRole[access-level]">
                                                            <option value="1">Direct Reports</option>
                                                            <option value="2"> Direct + Indirect Reports </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <hr>
                                                            ...
                                                            <div class="row col-md-12 pl-2">
                                                                ...
                                                                <div class="row col-lg-9 col-md-12 col-sm-12">
                                                                    <div class="mt-2 flex-fill col-md-7 col-sm-4">
                                                                        <input type="hidden" id="{{$group}}{{$fieldName}}SelectedValue" name="managerRole[permission][]">
                                                                    ...
                                                                    <div class="mt-1 flex-fill col-md-5 col-sm-6">
                                                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                                            ...
                                                                            <label class="btn btn-primary p-1 {{$category}}_edit_button">
                                                                                ...
                                                                                <input type="radio" class="{{$category}}_edit" id="{{$group}}{{$fieldName}}edit" access="edit" permission="{{$action}}" value="{{$group}}{{$fieldName}}" onclick="getPermissionValue(this);">
                                                                            </label>
                                                            ...
                                                            @elseif($group == "checkbox")
                                                                @if($category == "performance")
                                                                    <div class="custom-control custom-checkbox mt-1 ml-1">
                                                                        <input class="custom-control-input" type="checkbox" id="{{$category}}" value="{{$permission[$category][0]}}" name="managerRole[permission][]">
                                                                ...
                                                                @if($category == "attendance")
                                                                    <div class="custom-control custom-checkbox mt-1 ml-1">
                                                                        <input class="custom-control-input requestAttendance" type="checkbox" id="{{$category}}" value="view employee_attendance" name="managerRole[permission][]">
                                                                    ...
                                                                    <div class="col-12 attendanceList" style="display:none; width:  270px; border: 1px solid grey; border-radius: 5px; margin-left: 30px; margin-top: 2px; padding: 2px;">
                                                                        ...
                                                                        <div class="custom-control custom-checkbox">
                                                                            <input class="custom-control-input myCheckbox" type="checkbox" id="{{$fieldName}}" value="edit employee_attendance" name="managerRole[permission][]">
                                                                ...
                                                                @if($category == "time_off")
                                                                    <div class="custom-control custom-checkbox m-1">
                                                                        <input class="custom-control-input" type="checkbox" id="{{$category}}" value="{{$permission['time_off_decision'][0]}}" name="managerRole[permission][]">
                                                                        <label for="{{$category}}" class="custom-control-label">{{ucwords($permission['time_off_decision'][0])}}</label>
                                                                    </div>
                                                                @endif
                                                            @else
                                                                    ...
                                                                    <div class="row col-lg-9 col-md-12 col-sm-12">
                                                                        ...
                                                                        <div class="mt-1 flex-fill col-md-5 col-sm-8">
                                                                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                                                <label class="btn btn-primary active p-1 {{$category}}_no_access_button">
                                                                                    <i data-feather='lock'></i>
                                                                                    <input type="radio" class="{{$category}}_no_access" id="{{$group}}{{$fieldName}}no_access" value="{{$group}}{{$fieldName}}" access="no_access" permission="" checked onclick="getPermissionValue(this);">
                                                                                </label>
                                                                                @foreach($permissionActions as $action)
                                                                                @if(strpos($action, 'view') !== false)
                                                                                <label class="btn btn-primary p-1 {{$category}}_view_button">
...
{{--                                                                        </div>--}}
                                            ...
                                            <div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
                                                ...
                                                <div class="form-check mt-2 ml-1">
                                                    <input type="radio" class="form-check-input" name="hasEmployeeRole" value="yes" checked id="yesRadiobtn">
                                                    <label class="form-check-label" for="yesRadiobtn">
                                                        Yes, Allow Access
                                                    </label>
                                                </div>
                                                <div class="form-check mt-1 ml-1">
                                                    <input type="radio" class="form-check-input" name="hasEmployeeRole" value="no" id="noRadiobtn">
                                                ...
                                                <div id="toggleAccessWithRadioBtn" class="mt-1 ml-1">
                                                    ...
                                                    <select class="form-control col-md-3" name="employeeRole" id="selectLevel">
                                                ...
                                                <div class="row ml-1">
                                                    ...
                                                    <div class="dropdown col-12" id="timeOffDropdown">
                                                        <a data-toggle="dropdown" class="btn btn-primary ml-1 dropdown-toggle">All Current And
                                                            Future Time Off Types
                                                        </a>
