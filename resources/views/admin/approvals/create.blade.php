...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><i class="fas fa-thumbs-up"></i> {{__('language.Create a New Approval')}}</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a>{{__('language.Settings')}}</a></li>
                    <li class="breadcrumb-item active"><a href="@if(isset($locale)){{url($locale.'/approvals')}} @else {{url('en/approvals')}} @endif">{{__('language.Approvals')}}</a></li>
...
<div class="container-fluid">
    <div class="card">
        <div class="col-md-12 card-body">
            ...
            <form action="@if(isset($locale)){{url($locale.'/approvals')}} @else {{url('en/approvals')}} @endif" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-group col-md-12 mt-3">
                    <div class="form-group ">
                        <label class="control-label">Approval Name <span>*</span></label>
                        <input class="form-control col-md-2" maxlength="100" type="text" required="required" name="name" />
                    </div>
                    <div class="form-group ">
                        <label class="control-label">Description <span>*</span></label>
                        <textarea class=" form-control col-md-3" rows="4" required="required" name="description"></textarea>
                    </div>
                </div>
                <br>
                <hr>
