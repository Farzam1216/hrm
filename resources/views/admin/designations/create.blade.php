	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card card-outline-info">
                <form id="designation-form" action="@if(isset($locale)){{url($locale.'/designations')}} @else {{url('en/designations')}} @endif" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <br>
                     <div class="row">
                        <div class="col-md-6 pl-3">
                            <div class="form-group">
                                ...
                                <input  type="text" name="designation_name" id="designation_name" placeholder="{{__('language.Enter')}} {{__('language.Designation')}} {{__('language.Name')}} {{__('language.Here')}}" class="form-control">
                            </div>
                        </div>
                    ...
                    <div class="col-12 d-flex flex-sm-row flex-column mt-2 mb-2">
                        <button  type="submit" class="btn btn-primary mb-1 mb-sm-0 mr-0 ml-1 mr-sm-1 waves-effect waves-float waves-light">{{__('language.Add')}} {{__('language.Designation')}}</button>
