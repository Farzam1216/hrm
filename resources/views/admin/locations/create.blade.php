	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card card-outline-info">
				<form id="location-create-form" action="@if(isset($locale)){{url($locale.'/locations')}} @else {{url('en/locations')}} @endif" method="post" enctype="multipart/form-data">
					{{csrf_field()}}
					<br>
					<div class="form-body">
						<div class="row">
							...
							<div class="col-md-6 pr-3">
								<div class="form-group">
									...
									<input type="tel" name="phone_number" class="form-control" placeholder="{{__('language.Enter Phone Number here')}}" value="{{old('phone_number')}}">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12 pl-3 pr-3">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label class="control-label">{{__('language.Enter')}} {{__('language.City')}}<span class="text-danger">*</label>
					...
					<div class="col-12 d-flex flex-sm-row flex-column mb-2">
						<button type="submit" class="btn btn-primary mb-1 mb-sm-0 ml-1 mr-0 mr-sm-1 waves-effect waves-float waves-light">{{__('language.Create')}} {{__('language.Location')}}</button>
