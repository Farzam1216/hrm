...
@section('title','New Employee Access Level')
@section('heading')
...
<div class="row">
    <div class="container-fluid">
        <form id="employeeRole" action="@if(isset($locale)){{url($locale.'/access-level/employee')}}@else{{url('en/access-level/employee')}}@endif" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="row col-md-12 pl-2">
                                                                ...
                                                                <div class="row col-lg-9 col-md-12 col-sm-12">
                                                                    <div class="mt-2 flex-fill col-md-7 col-sm-4">
                                                                        <input type="hidden" id="{{$group}}{{$fieldName}}SelectedValue" name="employeePermission[]">
                                                                    ...
                                                                    <div class="mt-1 flex-fill col-md-5 col-sm-6">
                                                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                                            <label class="btn btn-primary active p-1 {{$category}}_no_access_button"><i data-feather='lock'></i>
                                                                            ...
                                                                            <label class="btn btn-primary p-1 {{$category}}_view_button"><i data-feather='eye'></i>
                                                            ...
                                                            <div class="d-flex flex-row">
                                                                <div class="mt-1 ml-1 checkbox">
                                                                    ...
                                                                    <div class="custom-control custom-control-primary custom-checkbox">
                                                                        <input type="checkbox" class="custom-control-input requestTimeOffType" id="colorCheck1">
                                                                        <label class=" custom-control-label" for="colorCheck1">
                                                                            {{ucwords (str_replace ('_',' ', $checkBox))}}
                                                                        </label>
                                                                    </div>
                                                                    <div class="col-12 timeOffTypeList" style="display:none; width:  auto; border: 1px solid grey; border-radius: 5px; margin-left: 30px; margin-top: 2px; padding: 2px;">
                                                                        @foreach($value as $permissionLabel=>$permissionValue)
                                                                        <div class="custom-control custom-checkbox">
                                                                            <input class="custom-control-input" type="checkbox" id="{{$permissionLabel}}" value="{{$permissionValue[0]}}" name="employeePermission[]">
                                                                    ...
                                                                    <div class="custom-control custom-control-primary custom-checkbox">
                                                                        <input type="checkbox" name="employeePermission[]" value="view employee_attendance" class="custom-control-input requestAttendance" id="colorCheck3">
                                                                        <label class=" custom-control-label" for="colorCheck3">
                                                                            {{ucwords (str_replace ('_',' ', $checkBox))}}
                                                                        </label>
                                                                    </div>
                                                                    <div class="col-12 attendanceList" style="display:none; width:  auto; border: 1px solid grey; border-radius: 5px; margin-left: 30px; margin-top: 2px; padding: 2px;">
                                                                        @foreach($value as $permissionLabel=>$permissionValue)
                                                                        <div class="custom-control custom-checkbox">
                                                                            <input class="custom-control-input myCheckbox" type="checkbox" id="{{$permissionLabel}}" value="edit employee_attendance" name="employeePermission[]">
                                                                            <label for="{{$permissionLabel}}" class="custom-control-label">{{ucwords (str_replace ('_',' ', $permissionLabel))}}</label>
                                                                        </div>
                                                                        @endforeach
                                                                    </div>
                                                                    @else
                                                                        @if($checkBox != "time_off_decision")
                                                                            <div class="custom-control custom-control-primary custom-checkbox">
                                                                                <input type="checkbox" class="custom-control-input" id="colorCheck2" name="employeePermission[]" value="{{$value[0]}}">
                                                                ...
                                                                <div class="row col-md-12 pl-2">
                                                                    ...
                                                                    <div class="row col-lg-9 col-md-12 col-sm-12">
                                                                        ...
                                                                        <div class="mt-1 flex-fill col-md-5 col-sm-6">
                                                                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                                                <label class="btn btn-primary active p-1 {{$category}}_no_access_button"><i data-feather='lock'></i>
                                                                                    <input type="radio" class="{{$category}}_no_access" id="{{$group}}{{$fieldName}}no_access" access="no_access" value="{{$group}}{{$fieldName}}" permission="" checked onclick="getPermissionValue(this);">
                                                                                </label>
                                                                                @foreach($permissionActions as $action)
                                                                                @if(strpos($action, 'view') !== false)
                                                                                <label class="btn btn-primary p-1 {{$category}}_view_button"><i data-feather='eye'></i>
                                                                                ...
                                                                                @elseif(strpos($action, 'edit ') !== false)
                                                                                <label class="btn btn-primary p-1 {{$category}}_edit_button"> <i data-feather='edit-2'></i> <input type="radio" class="{{$category}}_edit" id="{{$group}}{{$fieldName}}edit" access="edit" permission="{{$action}}" value="{{$group}}{{$fieldName}}" onclick="getPermissionValue(this);">
                                                                                </label>
                                                                                @elseif(strpos($action, 'edit_with_approval') !== false)
                                                                                <label class="btn btn-primary p-1 {{$category}}_edit_with_approval_button"> <i data-feather='user-check'></i> <input type="radio" class="{{$category}}_edit_with_approval" id="{{$group}}{{$fieldName}}edit_with_approval" access="edit_with_approval" permission="{{$action}}" value="{{$group}}{{$fieldName}}" onclick="getPermissionValue(this);">
                                                                                </label>
                                                                                @endif
                                                                                @endforeach
                                                                            </div>
...
<script>
    ...
    //Show/Hide Time Off Types List on "Can request time off" checkbox change
    $('.requestTimeOffType').change(function() {
        console.log('hi');
        if (this.checked) {
