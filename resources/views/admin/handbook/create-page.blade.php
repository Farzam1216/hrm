...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form id="handbook-form" action="@if(isset($locale)) {{route('chapter.page.store', [$locale, $chapter->id])}} @else {{route('chapter.page.store', ['en', $chapter->id])}} @endif" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" value="{{ old('page_title') }}" name="page_title" class="form-control" placeholder="{{__('language.Enter')}} {{__('language.Page Title')}}" autofocus>
                        </div>
