    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="pt-1" id="edit-attendance" action="@if(isset($locale)) {{route('employees.employee-attendance.update', [$locale, $employeeAttendance->employee_id, $date])}} @else {{route('employees.employee-attendance.update', ['en', $employeeAttendance->employee_id, $date])}} @endif" method="post">
                    ...
                    <div class="row col-12">
                        ...
                        <button type="button" onclick="window.location.href='@if(isset($locale)){{route('employees.employee-attendance.show', [$locale, $employee->id, $date])}} @else {{route('employees.employee-attendance.show', ['en', $employee->id, $date])}} @endif'" class="btn btn-outline-warning waves-effect">{{__('language.Cancel')}}
                        </button>
                    </div>
