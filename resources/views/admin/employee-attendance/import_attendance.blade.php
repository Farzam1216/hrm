    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-body">
                    <form id="import-form" action="@if(isset($locale)) {{route('import.attendance.show', [$locale, 'preview'])}} @else {{route('import.attendance.show', ['en', 'preview'])}} @endif" method="post" enctype="multipart/form-data">
                        ...
                        <a class="btn-sm pl-0" href="{{ asset('sheets/employee_attendance_template.xlsx') }}" download><i data-feather="download"></i> {{__('language.Click Here To Download Sample Sheet Template')}}</a>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button type="button" onclick="window.location.href='@if(isset($locale)){{url($locale.'/employees/'.$employeeId.'/employee-attendance')}} @else {{url('en/employees/'.$employeeId.'/employee-attendance')}} @endif'" class="btn btn-outline-warning waves-effect"><span class="d-lg-none d-md-none d-sm-inline"><i data-feather="x-circle"></i></span><span class="d-none d-lg-inline d-md-inline d-sm-none">Cancel</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
