...
<div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">{{__('language.Salary')}} {{__('language.Slip')}}</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="control-label text-right col-md-3">{{__('language.Employee')}}</label>
                                        <div class="col-md-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="control-label text-right col-md-3">{{__('language.Month')}} {{__('language.And')}} {{__('language.Year')}}</label>
                                        <div class="col-md-9">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button type="button"
                                                    onclick="window.location.href='@if(isset($locale)){{url($locale.'/generate-salary-slip')}} @else {{url('en/generate-salary-slip')}} @endif'"
