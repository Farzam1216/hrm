            ...
            <div class="col-12">
                <div class="card ">
                    <div class="card-header">
                        <h4 class="card-title pt-1 pl-2">Update Time Off Type</h4>
                    </div>
                    <div class="card-body pt-1">
                        <form class="form" method="post" action="@if(isset($locale)){{url($locale.'/time-off-type/'.$timeOffType->id)}} @else {{url('en/time-off-type/'.$timeOffType->id)}} @endif" id="time-off-type">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input
                                                value="{{$timeOffType->time_off_type_name}}"
                                                type="text"
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary mr-1">{{__('language.Update')}} {{__('language.Time Off')}} {{__('language.Type')}}</button>
