...
class CreateDeleteEmployeeBenefitTrigger extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared('CREATE TRIGGER delete_employee_benefit_trigger BEFORE DELETE ON employee_benefits FOR EACH ROW
        BEGIN
    ...
    {
        DB::unprepared('DROP TRIGGER `delete_employee_benefit_trigger`');
    }
}
