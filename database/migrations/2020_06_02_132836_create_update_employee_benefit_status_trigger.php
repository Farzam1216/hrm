...
class CreateUpdateEmployeeBenefitStatusTrigger extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared('CREATE TRIGGER update_employee_benefit_status_trigger BEFORE UPDATE ON employee_benefit_statuses FOR EACH ROW
        BEGIN
    ...
    {
        DB::unprepared('DROP TRIGGER `update_employee_benefit_status_trigger`');
    }
}
